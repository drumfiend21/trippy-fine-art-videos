window.setParticle = (stringVal, colors) => {
    ...
    writeText(c2.canvas, c2.context, stringVal)
    ...
    class Particle{
        constructor(canvas, options){
            ...
            this.color  = this.randomColor()//this.radius > 5 ? "#FF5E4C" : "#ED413C" //this.randomColor()
        }

        randomColor() {
            // let colors = ["#E6FB04", "#FF6600", "#33FF00", "#00FFFF", "#FF00FF", "#FF0099"];
